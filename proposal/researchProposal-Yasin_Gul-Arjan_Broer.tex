...
\begin{document}
    ...
    Examples include suggesting dangerous dosages, recommending inappropriate medications, or failing to warn against contraindications \cite{luo2024clinical}, \cite{schieszer2023large}.
    ...
    Todo: explain dataset and validation
