...
The dataset will consist of a set of 200 medical questions and relevant patient information including age, gender and reported symptoms.
The medical questions and patient information will be used as prompt input for the baseline setup, and the recipes will be used to evaluate the correctness of the generated output.
...
To make sure the dataset is representative of real-world medical questions all questions have been reviewed by a medical expert.
